 ...
 * Dibuja las piezas del puzzle y recoge los eventos de ratón al pincharlas con
 * el ratón.
 * Utiliza la clase Puzzle, que es la que tiene el juego, para saber dónde
...
public class GuiTablero extends Canvas
{
    public GuiTablero (Image [] imagenes, Puzzle unPuzzle)
    {
        ...
        /* Añade un observador de movimientos a Puzzle, de forma que cada vez
        ...
        /* Añade un MouseListener para enterarse de cuando se hace click en
     ...
     * en pantalla.
     * Recibe la posición x,y en la que se ha pinchado con el ratón, la traduce
    ...
    public void mueve (int x, int y)
    {
        ...
        /* Traducción de pixel x,y a fila,columna del tablero */
        fila = y/32;
        columna = x/32;
    ...
    /**
     * Devuelve el tamaño preferido para el tablero en pixels.
     * Se le pide a Puzzle el número de filas y columnas. Como cada imagen
     * se supone que ocupa 32x32, se obtiene fácilmente el ancho y alto 
    ...
    public void paint (Graphics g)
    {
        ...
        for (fila=0; fila < puzzle.dameFilas(); fila++)
            ...
            {
                /* Se recoge el número de la pieza en fila,columna */
    ...
    /**
     * Dimensión preferida para el tablero en pixels de pantalla.
     */
